 ...
 */
function check(needle, haystack, wild) {
  ...
  for (var i = 0; i < needle.length; i++) {
    var ret = test(needle[i], haystack, wild)
    if (ret) {
      return true
    }
  }
 ...
 */
function test(needle, haystack, wild) {
